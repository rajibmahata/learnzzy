...
export const WORLD_EVENT_CONFIGS: Record<string, WorldRewardEvent> = {
  ...
  robot: { rewardId: "robot", category: "discovery", eventType: "CREATURE_ARRIVAL", environment: "playroom", asset: { emoji: "🤖", scale: 1.4, entranceDirection: "right" }, animation: "walk", durationMs: 6200, soundEffects: ["beep", "roll"], particleEffects: ["sparkles"], companionReaction: "excited", rewardTags: ["robot"], learningThemes: ["robots", "sequencing"], gameAffinity: ["thinking", "puzzle"] },
};
