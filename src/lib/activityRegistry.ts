...
export const ACTIVITY_REGISTRY: ActivityDef[] = [
  ...
  // ---- Phase 3 — Dynamic Adventure 8 (world-scalable, different mechanics) ----
  { id: "color-detective", category: "discover", title: "Color Detective", icon: "🌈", skills: ["color-recognition"], ageBands: ALL, activityType: "COLOR_DETECTIVE", complexityDimensions: ["itemCount", "optionCount", "visualComplexity"], generator: "color-detective", renderer: "generic-player", validator: "single-choice", blurb: "Find every red, blue or green treasure!" },
  { id: "animal-safari", category: "discover", title: "Animal Safari", icon: "🦁", skills: ["animal-recognition"], ageBands: ALL, activityType: "ANIMAL_SAFARI", complexityDimensions: ["itemCount", "visualComplexity"], generator: "animal-safari", renderer: "generic-player", validator: "single-choice", blurb: "Roam the jungle and spot the requested animal!" },
  { id: "butterfly-garden", category: "discover", title: "Butterfly Garden", icon: "🦋", skills: ["life-cycles"], ageBands: ALL, activityType: "BUTTERFLY_GARDEN", complexityDimensions: ["visualComplexity", "readingRequirement"], generator: "butterfly-garden", renderer: "generic-player", validator: "single-choice", blurb: "Egg → caterpillar → cocoon → butterfly!" },
  { id: "robot-path", category: "think", title: "Robot Path", icon: "🤖", skills: ["sequencing"], ageBands: ALL, activityType: "ROBOT_PATH", complexityDimensions: ["itemCount", "visualComplexity"], generator: "robot-path", renderer: "generic-player", validator: "single-choice", blurb: "Guide the robot: UP, RIGHT, RIGHT, DOWN → star!" },
  { id: "fruit-sorting", category: "think", title: "Fruit Sorting", icon: "🍎", skills: ["sorting"], ageBands: ALL, activityType: "FRUIT_SORTING", complexityDimensions: ["itemCount", "optionCount"], generator: "fruit-sorting", renderer: "generic-player", validator: "single-choice", blurb: "Sort fruits by color and kind!" },
  { id: "draw-a-monster", category: "write", title: "Draw a Monster", icon: "👾", skills: ["creativity"], ageBands: ALL, activityType: "DRAW_MONSTER", complexityDimensions: ["visualComplexity", "writingRequirement"], generator: "draw-a-monster", renderer: "generic-player", validator: "single-choice", blurb: "Create without a single correct answer — celebrated!" },
  { id: "balloon-words", category: "words", title: "Balloon Burst — Letters", icon: "🎈", skills: ["phonics", "letter-recognition"], ageBands: ALL, activityType: "BALLOON_LETTER_BURST", complexityDimensions: ["readingRequirement", "itemCount", "visualComplexity"], href: "/play/balloon-words", renderer: "game-route", validator: "single-choice", blurb: "Balloons float with letters — tap or type to burst the right one!" },
  { id: "balloon-animals", category: "discover", title: "Balloon Burst — Animals", icon: "🐱", skills: ["animal-recognition", "word-recognition"], ageBands: ALL, activityType: "BALLOON_ANIMAL_BURST", complexityDimensions: ["readingRequirement", "itemCount", "visualComplexity"], href: "/play/balloon-animals", renderer: "game-route", validator: "single-choice", blurb: "Balloons carry animals — find the cat 🐱, burst it and learn C-A-T!" },
  { id: "knowledge-check-numbers", category: "numbers", title: "Numbers Check", icon: "🧠", skills: ["addition", "subtraction", "counting"], ageBands: ["4-5", "6-7", "8-9"], activityType: "KNOWLEDGE_CHECK", complexityDimensions: ["numberRange", "itemCount", "readingRequirement"], generator: "knowledge-check-numbers", renderer: "generic-player", validator: "single-choice", blurb: "Test what you know — mixed numbers quiz!" },
  { id: "knowledge-check-words", category: "words", title: "Words Check", icon: "📝", skills: ["phonics", "word-recognition"], ageBands: ["4-5", "6-7", "8-9"], activityType: "KNOWLEDGE_CHECK_WORDS", complexityDimensions: ["readingRequirement", "optionCount", "visualComplexity"], generator: "knowledge-check-words", renderer: "generic-player", validator: "single-choice", blurb: "Test word families and listening!" },
  { id: "division-share", category: "numbers", title: "Share Equally", icon: "🍎", skills: ["division"], ageBands: ALL, activityType: "DIVISION_SHARE", complexityDimensions: ["numberRange", "itemCount", "visualSupport"], generator: "division-share", renderer: "generic-player", validator: "single-choice", blurb: "Share treats equally — early division!" },
  { id: "measurement", category: "think", title: "Tall or Short?", icon: "📏", skills: ["measurement"], ageBands: ALL, activityType: "MEASUREMENT", complexityDimensions: ["itemCount", "visualComplexity"], generator: "measurement", renderer: "generic-player", validator: "single-choice", blurb: "Which tower is taller?" },
  { id: "science-observe", category: "discover", title: "Living or Not?", icon: "🔬", skills: ["observation"], ageBands: ALL, activityType: "SCIENCE_OBSERVE", complexityDimensions: ["visualComplexity", "readingRequirement"], generator: "science-observe", renderer: "generic-player", validator: "single-choice", blurb: "Observe and classify living things!" },
];
