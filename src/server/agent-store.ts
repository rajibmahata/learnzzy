...
export const AGENTS: AgentDef[] = [
  ...
  { agentId: "academic-agent", name: "Academic Agent", type: "academic", description: "Builds validated learning plans (learn→master) from mastery + MCP advisories.", queue: "academic-plan", read: ["learners", "learningSignals", "gameEvents", "academicPlans", "content"], write: ["academicPlans", "learningSignals", "agentTasks", "agentRuns", "agentEvents", "aiUsage"] },
